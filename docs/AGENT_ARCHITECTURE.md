# Rash Agent Architecture

This document illustrates how the AI agents in the Rash platform collaborate to provide comprehensive financial planning and portfolio analysis.
...
graph TB
    ...
    Schedule[EventBridge<br/>Every 2 Hours<br/>optional] -->|Trigger| Researcher[Researcher<br/>Agent]
...
```text
EventBridge (Every 2hrs, optional) → Researcher → S3 Vectors → Knowledge Base Growth
```
