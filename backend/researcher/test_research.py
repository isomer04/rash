...
TERRAFORM_DIR = "terraform/stacks/researcher"
...
def get_service_url():
    ...
    try:
        ...
        print("   Make sure terraform/stacks/researcher has been applied after deploying the image.")
        sys.exit(1)
...
def main():
    parser = argparse.ArgumentParser(
        description="Test the Rash Researcher service",
