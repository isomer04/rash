...
TAGGER_FUNCTION = os.getenv("TAGGER_FUNCTION", "rash-tagger")
REPORTER_FUNCTION = os.getenv("REPORTER_FUNCTION", "rash-reporter")
CHARTER_FUNCTION = os.getenv("CHARTER_FUNCTION", "rash-charter")
RETIREMENT_FUNCTION = os.getenv("RETIREMENT_FUNCTION", "rash-retirement")
