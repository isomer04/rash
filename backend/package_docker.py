...
# The progress output uses emoji, which a Windows cp1252 console cannot encode.
...
def main():
    ...
    if success_count == total_count:
        ...
        print("\nNext steps:")
        print("1. Deploy infrastructure: cd terraform/stacks/agents")
        print("   terraform init -backend-config=backend.hcl   # first time only")
